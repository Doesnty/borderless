...
extern const u8 gText_OhNoICantBuyTMs[];
extern const u8 gText_OhNoICantBuyBerries[];
...
extern const u8 gText_BattleNoNoChoice[];
...
extern const u8 gText_EffortWasReset[];
...
extern const u8 gText_MusicTouhou[];
extern const u8 gText_MusicPokemon[];
...
extern const u8 gText_ThatsSoldOut[];
...
extern const u8 gText_DexCategory_LOLKPkmn[];
extern const u8 gText_DexCategory_HSIFSPkmn[];
extern const u8 gText_DexCategory_WBAWCPkmn[];
extern const u8 gText_DexCategory_UMPkmn[];
extern const u8 gText_DexCategory_UDOALGPkmn[];
extern const u8 gText_DexCategory_FWPkmn[];
extern const u8 gText_DexCategory_FightersPkmn[];
extern const u8 gText_DexCategory_WrittenWorksPkmn[];
extern const u8 gText_DexCategory_HRTPPkmn[];
extern const u8 gText_DexCategory_SOEWPkmn[];
extern const u8 gText_DexCategory_PODDPkmn[];
extern const u8 gText_DexCategory_LLSPkmn[];
extern const u8 gText_DexCategory_MSPkmn[];
extern const u8 gText_DexCategory_FanonPkmn[];
extern const u8 gText_DexCategory_SpecialPkmn[];
...
extern const u8 gText_PokeSum_FatefulEncounterHatched_NatureChanged[];
extern const u8 gText_PokeSum_FatefulEncounterHatched[];
extern const u8 gText_PokeSum_Hatched_NatureChanged[];
extern const u8 gText_PokeSum_Hatched[];
extern const u8 gText_PokeSum_FatefulEncounterMet_NatureChanged[];
extern const u8 gText_PokeSum_FatefulEncounterMet[];
extern const u8 gText_PokeSum_Met_NatureChanged[];
extern const u8 gText_PokeSum_Met[];
extern const u8 gText_PokeSum_MetInATrade_NatureChanged[];
extern const u8 gText_PokeSum_MetInATrade[];
extern const u8 gText_PokeSum_ApparentlyFatefulEncounterHatched_NatureChanged[];
extern const u8 gText_PokeSum_ApparentlyFatefulEncounterHatched[];
extern const u8 gText_PokeSum_ApparentlyMet[];
extern const u8 gText_PokeSum_ApparentlyMet_NatureChanged[];
...
extern const u8 gText_ZunReimu[];
extern const u8 gText_ZunMarisa[];
extern const u8 gText_ZunRumia[];
extern const u8 gText_ZunDaiyousei[];
extern const u8 gText_ZunCirno[];
extern const u8 gText_ZunMeiling[];
extern const u8 gText_ZunKoakuma[];
extern const u8 gText_ZunPatchouli[];
extern const u8 gText_ZunSakuya[];
extern const u8 gText_ZunRemilia[];
extern const u8 gText_ZunFlandre[];
extern const u8 gText_ZunLetty[];
extern const u8 gText_ZunChen[];
extern const u8 gText_ZunAlice[];
extern const u8 gText_ZunLilyWhite[];
extern const u8 gText_ZunLilyBlack[];
extern const u8 gText_ZunLunasa[];
extern const u8 gText_ZunMerlin[];
extern const u8 gText_ZunLyrica[];
extern const u8 gText_ZunYoumu[];
extern const u8 gText_ZunYuyuko[];
extern const u8 gText_ZunRan[];
extern const u8 gText_ZunYukari[];
extern const u8 gText_ZunSuika[];
extern const u8 gText_ZunWriggle[];
extern const u8 gText_ZunMystia[];
extern const u8 gText_ZunKeine[];
extern const u8 gText_ZunTewi[];
extern const u8 gText_ZunReisen[];
extern const u8 gText_ZunEirin[];
extern const u8 gText_ZunKaguya[];
extern const u8 gText_ZunMokou[];
extern const u8 gText_ZunAya[];
extern const u8 gText_ZunMedicine[];
extern const u8 gText_ZunYuuka[];
extern const u8 gText_ZunKomachi[];
extern const u8 gText_ZunEiki[];
extern const u8 gText_ZunAkyuu[];
extern const u8 gText_ZunShizuha[];
extern const u8 gText_ZunMinoriko[];
extern const u8 gText_ZunHina[];
extern const u8 gText_ZunNitori[];
extern const u8 gText_ZunMomiji[];
extern const u8 gText_ZunSanae[];
extern const u8 gText_ZunKanako[];
extern const u8 gText_ZunSuwako[];
extern const u8 gText_ZunReisenII[];
extern const u8 gText_ZunToyohime[];
extern const u8 gText_ZunYorihime[];
extern const u8 gText_ZunIku[];
extern const u8 gText_ZunTenshi[];
extern const u8 gText_ZunKisume[];
extern const u8 gText_ZunYamame[];
extern const u8 gText_ZunParsee[];
extern const u8 gText_ZunYuugi[];
extern const u8 gText_ZunSatori[];
extern const u8 gText_ZunRin[];
extern const u8 gText_ZunUtsuho[];
extern const u8 gText_ZunKoishi[];
extern const u8 gText_ZunNazrin[];
extern const u8 gText_ZunKogasa[];
extern const u8 gText_ZunIchirin[];
extern const u8 gText_ZunMurasa[];
extern const u8 gText_ZunShou[];
extern const u8 gText_ZunByakuren[];
extern const u8 gText_ZunNue[];
extern const u8 gText_ZunShanghai[];
extern const u8 gText_ZunHourai[];
extern const u8 gText_ZunHatate[];
extern const u8 gText_ZunSunny[];
extern const u8 gText_ZunLuna[];
extern const u8 gText_ZunStar[];
extern const u8 gText_ZunRinnosuke[];
extern const u8 gText_ZunTokiko[];
extern const u8 gText_ZunKyouko[];
extern const u8 gText_ZunYoshika[];
extern const u8 gText_ZunSeiga[];
extern const u8 gText_ZunTojiko[];
extern const u8 gText_ZunFuto[];
extern const u8 gText_ZunMiko[];
extern const u8 gText_ZunMamizou[];
extern const u8 gText_ZunKosuzu[];
extern const u8 gText_ZunKokoro[];
extern const u8 gText_ZunWakasagihime[];
extern const u8 gText_ZunSekibanki[];
extern const u8 gText_ZunKagerou[];
extern const u8 gText_ZunBenben[];
extern const u8 gText_ZunYatsuhashi[];
extern const u8 gText_ZunSeija[];
extern const u8 gText_ZunShinmyoumaru[];
extern const u8 gText_ZunRaiko[];
extern const u8 gText_ZunKasen[];
extern const u8 gText_ZunSumireko[];
extern const u8 gText_ZunSeiran[];
extern const u8 gText_ZunRingo[];
extern const u8 gText_ZunDoremy[];
extern const u8 gText_ZunSagume[];
extern const u8 gText_ZunClownpiece[];
extern const u8 gText_ZunJunko[];
extern const u8 gText_ZunHecatia[];
extern const u8 gText_ZunJoon[];
extern const u8 gText_ZunShion[];
extern const u8 gText_ZunEternity[];
extern const u8 gText_ZunNemuno[];
extern const u8 gText_ZunAunn[];
extern const u8 gText_ZunNarumi[];
extern const u8 gText_ZunMai[];
extern const u8 gText_ZunSatono[];
extern const u8 gText_ZunOkina[];
extern const u8 gText_ZunEika[];
extern const u8 gText_ZunUrumi[];
extern const u8 gText_ZunKutaka[];
extern const u8 gText_ZunYachie[];
extern const u8 gText_ZunMayumi[];
extern const u8 gText_ZunKeiki[];
extern const u8 gText_ZunSaki[];
extern const u8 gText_ZunYuuma[];
extern const u8 gText_ZunMike[];
extern const u8 gText_ZunTakane[];
extern const u8 gText_ZunSannyo[];
extern const u8 gText_ZunMisumaru[];
extern const u8 gText_ZunTsukasa[];
extern const u8 gText_ZunMegumu[];
...
extern const u8 gText_ZunHisami[];
extern const u8 gText_ZunZanmu[];
extern const u8 gText_ZunUbame[];
extern const u8 gText_ZunChimi[];
extern const u8 gText_ZunNareko[];
extern const u8 gText_ZunYuiman[];
extern const u8 gText_ZunAriya[];
extern const u8 gText_ZunNina[];
extern const u8 gText_ZunHakurei[];
extern const u8 gText_ZunKirisame[];
extern const u8 gText_ZunShingyoku[];
extern const u8 gText_ZunMagan[];
extern const u8 gText_ZunMima[];
extern const u8 gText_ZunElis[];
extern const u8 gText_ZunKikuri[];
extern const u8 gText_ZunKonngara[];
extern const u8 gText_ZunSariel[];
extern const u8 gText_ZunGenji[];
extern const u8 gText_ZunRika[];
extern const u8 gText_ZunMeira[];
extern const u8 gText_ZunEllen[];
extern const u8 gText_ZunKotohime[];
extern const u8 gText_ZunKana[];
extern const u8 gText_ZunRikako[];
extern const u8 gText_ZunChiyuri[];
extern const u8 gText_ZunYumemi[];
extern const u8 gText_ZunRuukoto[];
extern const u8 gText_ZunOrange[];
extern const u8 gText_ZunKurumi[];
extern const u8 gText_ZunElly[];
extern const u8 gText_ZunKazami[];
extern const u8 gText_ZunMugetsu[];
extern const u8 gText_ZunGengetsu[];
extern const u8 gText_ZunSara[];
extern const u8 gText_ZunLouise[];
extern const u8 gText_ZunArisu[];
extern const u8 gText_ZunYuki[];
extern const u8 gText_ZunMaiPC98[];
extern const u8 gText_ZunYumeko[];
extern const u8 gText_ZunShinki[];
extern const u8 gText_ZunSendai[];
extern const u8 gText_ZunTenma[];
extern const u8 gText_ZunLayla[];
extern const u8 gText_ZunYouki[];
extern const u8 gText_ZunTori[];
