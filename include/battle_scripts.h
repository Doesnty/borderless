...
extern const u8 BattleScript_BattleTowerTrainerBattleWon[];
extern const u8 BattleScript_SideTailwindWoreOff[];
extern const u8 BattleScript_FinishUTurn[];
extern const u8 BattleScript_HazardsAttacker[];
...
extern const u8 BattleScript_MoveSpeedDrain[];
extern const u8 BattleScript_MoveSpeedDrain_PPLoss[];
...
extern const u8 BattleScript_LooseLips[];
extern const u8 BattleScript_LunacyActivates[];
extern const u8 BattleScript_PowerLeakBoost[];
extern const u8 BattleScript_PowerLeakPenalty[];
extern const u8 BattleScript_SteadfastActivates[];
extern const u8 BattleScript_MoldBreakerAnnounces[];
extern const u8 BattleScript_PureFuriesAnnounces[];
extern const u8 BattleScript_ContagionSpreads[];
...
extern const u8 BattleScript_CursedBody[];
extern const u8 BattleScript_Justified[];
extern const u8 BattleScript_Moxie[];
extern const u8 BattleScript_DownloadAtk[];
