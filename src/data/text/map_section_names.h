...
const u8 gMapSecName_PokemonMansion[] = _("Puppet Mansion");
const u8 gMapSecName_SafariZone[] = _("Safari Zone");
const u8 gMapSecName_PokemonLeague[] = _("Puppet League");
const u8 gMapSecName_RockTunnel[] = _("Rock Tunnel");
const u8 gMapSecName_SeafoamIslands[] = _("Seafoam Islands");
const u8 gMapSecName_PokemonTower[] = _("Prism Tower");
...
const u8 gMapSecName_ResortGorgeous[] = _("Resort Gourgeous");
...
const u8 gMapSecName_BirthIsland[] = _("Birth Cavern");
