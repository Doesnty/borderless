const u8 gTrainerClassNames[][13] = {
    ...
    [TRAINER_CLASS_RS_POKEMANIAC]       = _("Tohomaniac"),
    ...
    [TRAINER_CLASS_POKEFAN]             = _("Tohofan"),
    ...
    [TRAINER_CLASS_RS_BUG_CATCHER]      = _("FairyCatcher"),
    ...
    [TRAINER_CLASS_TAMER]               = _("Beast Tamer"),
    ...
    [TRAINER_CLASS_PKMN_PROF]           = _("Puppet Prof."),
    ...
    [TRAINER_CLASS_BLACK_BELT_IMAKUNI]  = _("“Black Belt”"),
	[TRAINER_CLASS_STRANGEST]           = _("Strangest"),
	[TRAINER_CLASS_FAKE_ACE]            = _("Ace"),
	[TRAINER_CLASS_ROCKET_ADMIN]        = _("Rocket"),
};
