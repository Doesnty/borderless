...
static const u8 sRecollectionDescription[] = _("Transforms into foe at full HP.");
...
static const u8 sPowerLeakDescription[] = _("High Sp. Atk, but gradually lose it.");
static const u8 sHibernationDescription[] = _("Slight HP recovery while asleep.");
static const u8 sSteadfastDescription[] = _("Boost Speed after flinching.");
static const u8 sSolarPowerDescription[] = _("+50% Sp. Atk in sun, but lose HP.");
...
static const u8 sWinterGiftDescription[] = _("+50% Atk/Def/SAtk/SDef during hail.");
...
static const u8 sPerversionDescription[] = _("Swaps own Attack and Sp. Atk.");
...
static const u8 sAftermathDescription[] = _("If KO'd by contact, explodes.");
...
static const u8 sJealousyDescription[] = _("If itemless, +50% Def/SDef vs item holders.");
...
static const u8 sWideHatDescription[] = _("Blocks power moves and harmful weather.");
...
static const u8 sSapSipperDescription[] = _("Absorbs Nature moves into HP.");
...
static const u8 sFlowerGiftDescription[] = _("+50% Atk/Def/SAtk/SDef in sun.");
static const u8 sGaleWingsDescription[] = _("+1 Priority on Wind moves.");
static const u8 sRivalryDescription[] = _("Stronger vs same mana polarity.");
...
static const u8 sLastGrudgeDescription[] = _("When KO'd by move, lower PP to 1.");
static const u8 sSalvageArmorDescription[] = _("Boost Defense when puppets faint.");
...
const u8 *const gAbilityDescriptionPointers[ABILITIES_COUNT] =
{
    ...
    [ABILITY_RECOLLECTION] = sUnimplementedDescription,
    [ABILITY_LOOSE_LIPS] = sUnimplementedDescription,
    [ABILITY_LUNACY] = sUnimplementedDescription,
    [ABILITY_POWER_LEAK] = sUnimplementedDescription,
    [ABILITY_HIBERNATION] = sUnimplementedDescription,
    [ABILITY_STEADFAST] = sUnimplementedDescription,
    [ABILITY_SOLAR_POWER] = sUnimplementedDescription,
    [ABILITY_CHEERFUL] = sUnimplementedDescription,
    [ABILITY_STONEWORKER] = sUnimplementedDescription,
    [ABILITY_WINTER_GIFT] = sUnimplementedDescription,
    [ABILITY_PURE_FURIES] = sUnimplementedDescription,
    [ABILITY_PURE_ENIGMA] = sUnimplementedDescription,
    [ABILITY_PERVERSION] = sUnimplementedDescription,
    [ABILITY_STORM_SHAWL] = sUnimplementedDescription,
    [ABILITY_HARMONIZE] = sUnimplementedDescription,
    [ABILITY_CONTAGION] = sUnimplementedDescription,
    [ABILITY_DOLL_SKEWER] = sUnimplementedDescription,
    [ABILITY_AFTERMATH] = sUnimplementedDescription,
    [ABILITY_LECTURE] = sUnimplementedDescription,
    [ABILITY_RATTLED] = sUnimplementedDescription,
    [ABILITY_ANGER_POINT] = sUnimplementedDescription,
    [ABILITY_DOUR_ECHO] = sUnimplementedDescription,
    [ABILITY_MANIC_ECHO] = sUnimplementedDescription,
    [ABILITY_JEALOUSY] = sUnimplementedDescription,
    [ABILITY_PRIDE] = sUnimplementedDescription,
    [ABILITY_WALL_MASTER] = sUnimplementedDescription,
    [ABILITY_CATALYST] = sUnimplementedDescription,
    [ABILITY_WIDE_HAT] = sUnimplementedDescription,
    [ABILITY_FOREWARN] = sUnimplementedDescription,
    [ABILITY_SLUSH_RUSH] = sUnimplementedDescription,
    [ABILITY_SCRAPPY] = sUnimplementedDescription,
    [ABILITY_PROTEAN] = sUnimplementedDescription,
    [ABILITY_SUPER_LUCK] = sUnimplementedDescription,
    [ABILITY_SNOW_CLOAK] = sUnimplementedDescription,
    [ABILITY_UNBURDEN] = sUnimplementedDescription,
    [ABILITY_SKILL_LINK] = sUnimplementedDescription,
    [ABILITY_UNNERVE] = sUnimplementedDescription,
    [ABILITY_UNAWARE] = sUnimplementedDescription,
    [ABILITY_SAP_SIPPER] = sUnimplementedDescription,
    [ABILITY_GLUTTONY] = sUnimplementedDescription,
    [ABILITY_INFILTRATOR] = sUnimplementedDescription,
    [ABILITY_RECKLESS] = sUnimplementedDescription,
    [ABILITY_PRANKSTER] = sUnimplementedDescription,
    [ABILITY_SNIPER] = sUnimplementedDescription,
    ...
    [ABILITY_MOTOR_DRIVE] = sUnimplementedDescription,
    [ABILITY_STORM_DRAIN] = sUnimplementedDescription,
    [ABILITY_MOLD_BREAKER] = sUnimplementedDescription,
    [ABILITY_JUSTIFIED] = sUnimplementedDescription,
    [ABILITY_MOXIE] = sUnimplementedDescription,
    [ABILITY_MAGIC_GUARD] = sUnimplementedDescription,
    [ABILITY_SAND_RUSH] = sUnimplementedDescription,
    ...
    [ABILITY_NEUROFORCE] = sUnimplementedDescription,
    [ABILITY_NO_GUARD] = sUnimplementedDescription,
    [ABILITY_BAD_DREAMS] = sUnimplementedDescription,
    [ABILITY_WONDER_SKIN] = sUnimplementedDescription,
    [ABILITY_IRON_FIST] = sUnimplementedDescription,
    [ABILITY_KLUTZ] = sUnimplementedDescription,
    [ABILITY_FLOWER_GIFT] = sUnimplementedDescription,
    [ABILITY_GALE_WINGS] = sUnimplementedDescription,
    [ABILITY_RIVALRY] = sUnimplementedDescription,
    [ABILITY_FLARE_BOOST] = sUnimplementedDescription,
    [ABILITY_REGENERATOR] = sUnimplementedDescription,
    [ABILITY_MERCILESS] = sUnimplementedDescription,
    [ABILITY_ANTICIPATION] = sUnimplementedDescription,
    [ABILITY_TECHNICIAN] = sUnimplementedDescription,
    [ABILITY_BLANK_CARD] = sUnimplementedDescription,
    [ABILITY_REACTIVE] = sUnimplementedDescription,
    [ABILITY_DEVOURER] = sUnimplementedDescription,
    [ABILITY_LOST_DREAM] = sUnimplementedDescription,
    [ABILITY_LAST_WISH] = sUnimplementedDescription,
    [ABILITY_LAST_GRUDGE] = sUnimplementedDescription,
    [ABILITY_SALVAGE_ARMOR] = sUnimplementedDescription,
    [ABILITY_TANGLED_FEET] = sUnimplementedDescription,
    [ABILITY_TOXICOLOGIST] = sUnimplementedDescription,
    [ABILITY_SNOW_WARNING] = sUnimplementedDescription,
    [ABILITY_ADAPTABILITY] = sUnimplementedDescription,
...
const u8 gAbilityNames[ABILITIES_COUNT][ABILITY_NAME_LENGTH + 1] =
{
    ...
    [ABILITY_SALVAGE_ARMOR] = _("SalvageArmor"),
