const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_CBYAKUREN]  = {{EVO_LEVEL, 0, 39, SPECIES_BYAKUREN},
                             {EVO_LEVEL_HELD_ITEM, ITEM_GUARD_SHARD, 39, SPECIES_DBYAKUREN},
    ...
    [SPECIES_CSHINGYOKU] = {{EVO_LEVEL_HELD_ITEM, ITEM_POWER_SHARD, 25, SPECIES_SHINGYOKUO},
                             {EVO_LEVEL_HELD_ITEM, ITEM_GUARD_SHARD, 25, SPECIES_SHINGYOKUM},
                             {EVO_LEVEL_HELD_ITEM, ITEM_TECH_SHARD, 25, SPECIES_SHINGYOKUF}},
