const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_CCLOWNPIECE] = {{EVO_LEVEL, 0, 33, SPECIES_CLOWNPIECE},
	                         {EVO_LEVEL_HELD_ITEM, ITEM_GUARD_SHARD, 33, SPECIES_DCLOWNPIECE}},
    ...
    [SPECIES_CETERNITY]  = {{EVO_LEVEL, 0, 25, SPECIES_ETERNITY},
		                    {EVO_LEVEL_HELD_ITEM, ITEM_POWER_SHARD, 25, SPECIES_AETERNITY}},
	
    [SPECIES_CNEMUNO]    = {{EVO_LEVEL, 0, 29, SPECIES_NEMUNO},
		                    {EVO_LEVEL_HELD_ITEM, ITEM_GUARD_SHARD, 29, SPECIES_DNEMUNO}},
	
    [SPECIES_CAUNN]      = {{EVO_LEVEL, 0, 27, SPECIES_AUNN},
		                    {EVO_LEVEL_HELD_ITEM, ITEM_TECH_SHARD, 27, SPECIES_TAUNN}},
    ...
    [SPECIES_COKINA]     = {{EVO_LEVEL, 0, 41, SPECIES_OKINA},
		                    {EVO_LEVEL_HELD_ITEM, ITEM_GUARD_SHARD, 41, SPECIES_DOKINA}},
    
    [SPECIES_CEIKA]      = {{EVO_LEVEL, 0, 27, SPECIES_EIKA},
		                    {EVO_LEVEL_HELD_ITEM, ITEM_GUARD_SHARD, 27, SPECIES_DEIKA}},
	
    [SPECIES_CURUMI]     = {{EVO_LEVEL, 0, 29, SPECIES_URUMI}},
	
    [SPECIES_CKUTAKA]    = {{EVO_LEVEL, 0, 29, SPECIES_KUTAKA},
		                    {EVO_LEVEL_HELD_ITEM, ITEM_ASSIST_SHARD, 29, SPECIES_HKUTAKA}},
    ...
    [SPECIES_CSAKI]      = {{EVO_LEVEL, 0, 39, SPECIES_SAKI},
		                    {EVO_LEVEL_HELD_ITEM, ITEM_SWIFT_SHARD, 39, SPECIES_SSAKI}},
    ...
    [SPECIES_CTAKANE]    = {{EVO_LEVEL, 0, 33, SPECIES_TAKANE},
		                    {EVO_LEVEL_HELD_ITEM, ITEM_TECH_SHARD, 33, SPECIES_TTAKANE}},
    ...
    [SPECIES_CMEGUMU]    = {{EVO_LEVEL, 0, 35, SPECIES_MEGUMU},
		                    {EVO_LEVEL_HELD_ITEM, ITEM_TECH_SHARD, 35, SPECIES_TMEGUMU}},
	...
	[SPECIES_CUBAME]     = {{EVO_LEVEL, 0, 33, SPECIES_UBAME}},
	[SPECIES_CCHIMI]     = {{EVO_LEVEL, 0, 31, SPECIES_CHIMI}},
	[SPECIES_CNAREKO]    = {{EVO_LEVEL, 0, 31, SPECIES_NAREKO}},
	[SPECIES_CYUIMAN]    = {{EVO_LEVEL, 0, 33, SPECIES_YUIMAN}},
	
	[SPECIES_CARIYA]     = {{EVO_LEVEL, 0, 41, SPECIES_ARIYA},
		                    {EVO_LEVEL_HELD_ITEM, ITEM_GUARD_SHARD, 41, SPECIES_DARIYA}},
	
	[SPECIES_CNINA]     = {{EVO_LEVEL, 0, 39, SPECIES_NINA}},

    [SPECIES_CHAKUREI]   = {{EVO_LEVEL, 0, 39, SPECIES_HAKUREI}},
	
    [SPECIES_CKIRISAME]  = {{EVO_LEVEL, 0, 37, SPECIES_KIRISAME},
		                    {EVO_LEVEL_HELD_ITEM, ITEM_TECH_SHARD, 37, SPECIES_TKIRISAME}},
    ...
    [SPECIES_CKANA]      = {{EVO_LEVEL, 0, 29, SPECIES_KANA},
		                    {EVO_LEVEL_HELD_ITEM, ITEM_POWER_SHARD, 29, SPECIES_AKANA}},
    ...
    [SPECIES_CMUGETSU]   = {{EVO_LEVEL, 0, 39, SPECIES_MUGETSU},
		                    {EVO_LEVEL_HELD_ITEM, ITEM_ASSIST_SHARD, 39, SPECIES_HMUGETSU}},
    [SPECIES_CGENGETSU]  = {{EVO_LEVEL, 0, 39, SPECIES_GENGETSU},
		                    {EVO_LEVEL_HELD_ITEM, ITEM_POWER_SHARD, 39, SPECIES_AGENGETSU}},
    ...
    [SPECIES_CYUMEKO]    = {{EVO_LEVEL, 0, 37, SPECIES_YUMEKO},
		                    {EVO_LEVEL_HELD_ITEM, ITEM_TECH_SHARD, 37, SPECIES_TYUMEKO}},
