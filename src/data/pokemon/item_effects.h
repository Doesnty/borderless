...
const u8 *const gItemEffectTable[] =
{
    ...
    [ITEM_SWIFT_SHARD - ITEM_POTION] = sItemEffect_ThunderStone,
    [ITEM_TECH_SHARD - ITEM_POTION] = sItemEffect_WaterStone,
    [ITEM_ASSIST_SHARD - ITEM_POTION] = sItemEffect_LeafStone,
    [ITEM_AUTUMN_LEAF - ITEM_POTION] = sItemEffect_LeafStone,
    [ITEM_DUBIOUS_TOME - ITEM_POTION] = sItemEffect_LeafStone,
    [ITEM_OLD_TEXTBOOK - ITEM_POTION] = sItemEffect_LeafStone,
    [ITEM_SEAL_CRYSTAL - ITEM_POTION] = sItemEffect_LeafStone,
