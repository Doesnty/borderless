...
static const struct PartyMenuBoxInfoRects sPartyBoxInfoRects[] =
{
    [PARTY_BOX_LEFT_COLUMN] = 
    {
        BlitBitmapToPartyWindow_LeftColumn, 
        {
            ...
            85, 28, 24,  8, // Max HP
            56, 26, 48,  3, // HP bar
            50, 11, 56, 13, // Held item string
        }, 
        12, 23, 64, 16      // Description text (e.g. NO USE)
    },
    [PARTY_BOX_RIGHT_COLUMN] = 
    {
        BlitBitmapToPartyWindow_RightColumn, 
        {
            ...
            117, 12, 24,  8, // Max HP
             88, 10, 48,  3,  // HP bar
             40, 11, 40, 13, // Held item string
        }, 
        77, 28, 64, 16        // Description text
    },
};
...
static const u8 sPartyMenuSpriteCoords[PARTY_LAYOUT_COUNT][PARTY_SIZE][4 * 2] =
{
    ...
    [PARTY_LAYOUT_SINGLE] = 
    {
        { 16,  16,  52,  26,  30,  35,  16,  20},
        {136,  16, 172,  26, 150,  35, 136,  20},
        { 16,  56,  52,  66,  30,  75,  16,  60},
        {136,  56, 172,  66, 150,  75, 136,  60},
        { 16,  96,  52, 106,  30, 115,  16, 100},
        {136,  96, 172, 106, 150, 115, 136, 100},
    },
    [PARTY_LAYOUT_DOUBLE] = 
    {
        { 16,  16,  52,  26,  30,  35,  16,  20},
...
/*
    ...
    32, 33, 33, 33, 33, 33, 33, 33, 33, 33, 33, 33, 33, 34,
    40, 59, 60, 58, 58, 58, 58, 58, 58, 58, 58, 58, 58, 61,
    55, 56, 56, 56, 56, 56, 56, 56, 56, 56, 56, 56, 56, 57,
*/
};
...
} const sCursorOptions[] =
{
    ...
    [MENU_FIELD_MOVES + FIELD_MOVE_SWEET_SCENT] = {gMoveNames[MOVE_NATURE_POWER], CursorCB_FieldMove},
};
...
static const u16 sFieldMoves[] =
{
    ...
    MOVE_DIG, MOVE_SOFT_BOILED, MOVE_NATURE_POWER, FIELD_MOVE_END // this may be misuse of enum. same in emerald
};
