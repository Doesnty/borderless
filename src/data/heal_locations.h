static const struct HealLocation sSpawnPoints[] =
{
    ...
    [SPAWN_ROUTE_23 - 1] = {MAP_GROUP(ROUTE23), MAP_NUM(ROUTE23), 5, 29},
};
...
static const u16 sWhiteoutRespawnHealCenterMapIdxs[][2] =
{
    ...
    [SPAWN_ROUTE_23 - 1] = {MAP_GROUP(VIRIDIAN_CITY_POKEMON_CENTER_1F), MAP_NUM(VIRIDIAN_CITY_POKEMON_CENTER_1F)},
};
