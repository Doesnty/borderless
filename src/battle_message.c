...
static const u8 sText_PkmnHidUnderwater[] = _("{B_ATK_NAME_WITH_PREFIX} disappeared!");
...
static const u8 sText_PkmnChoseXAsDestiny[] = _("{B_ATK_NAME_WITH_PREFIX} fired a\nvolley of arrows upward!");
...
static const u8 sText_ItSuckedLiquidOoze[] = _("It took in the Strange Mist!");
...
static const u8 sText_ImakuniAboutToSwitchPkmn[] = _("{B_TRAINER1_CLASS} {B_TRAINER1_NAME} is\nabout to use something.\p{B_TRAINER1_CLASS} {B_TRAINER1_NAME} won't\nsay what he is sending out.\p{B_TRAINER1_CLASS} {B_TRAINER1_NAME} thinks\nvery lowly of abusing Shift mode.\pWill {B_PLAYER_NAME} change\nPuppets?");
...
const u8 sText_HurtByOwnAbility[] = _("{B_ATK_NAME_WITH_PREFIX} is hurt by\nits {B_ATK_ABILITY}!");
const u8 sText_ImakuniCard1[] = _("{B_TRAINER1_CLASS} {B_TRAINER1_NAME}\nused {B_LAST_ITEM}!");
const u8 sText_ImakuniCard2[] = _("{B_TRAINER1_CLASS} {B_TRAINER1_NAME} made\n{B_PLAYER_NAME} read the card text!");
const u8 sText_ImakuniCard3[] = _("Your Active Pokémon is now Confused.");
...
const u8 sText_AnticipationShudder[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s Anticipation\nmade it shudder!");
...
const u8 *const gBattleStringsTable[] = {
    ...
    [STRINGID_HURTBYSOLARPOWER - 12]              = sText_HurtByOwnAbility,
    [STRINGID_IMAKUNIABOUTTOSWITCHPKMN - 12]      = sText_ImakuniAboutToSwitchPkmn,
    [STRINGID_IMAKUNICARD1 - 12]                  = sText_ImakuniCard1,
    [STRINGID_IMAKUNICARD2 - 12]                  = sText_ImakuniCard2,
    [STRINGID_IMAKUNICARD3 - 12]                  = sText_ImakuniCard3,
...
const u8 gText_BattleNoNoChoice[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW 13 14 15}No?\nNo.");
...
#define HANDLE_NICKNAME_STRING_CASE(battlerId, monIndex)                \
    ...
    StringGetEndN(text, POKEMON_NAME_LENGTH);                           \
    toCpy = text;
    ...
    *dst = EOS;
    while (src[srcId] != B_BUFF_EOS)
    {
        ...
        case B_BUFF_MON_NICK: // poke nick without prefix
            ...
            StringGetEndN(dst, POKEMON_NAME_LENGTH);
            srcId += 3;
            break;
