...
static const u8 *const sMapNames[] = {
	...
	[MAPSEC_ROUTE_23_VICTORY_ROAD - MAPSECS_KANTO] = gMapSecName_Route23,
};
...
static const u16 sMapSectionTopLeftCorners[MAPSEC_COUNT][2] = {
    ...
    [MAPSEC_ROUTE_23            - MAPSECS_KANTO] = { 2,  5},
	...
	[MAPSEC_ROUTE_23_VICTORY_ROAD - MAPSECS_KANTO] = { 2, 4},
};
...
static const u16 sMapSectionDimensions[MAPSEC_COUNT][2] = {
    ...
    [MAPSEC_ROUTE_23_VICTORY_ROAD - MAPSECS_KANTO] = {1, 1},
};
...
static const u8 sRegionMapSections_Sevii67[LAYER_COUNT][MAP_HEIGHT][MAP_WIDTH] = {
    ...
    [LAYER_DUNGEON] =
    {
        {MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NAVEL_ROCK, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE},
        {MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE},
        {MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE},
...
static const u8 sMapFlyDestinations[][3] = {
	...
	[MAPSEC_ROUTE_23_VICTORY_ROAD - MAPSECS_KANTO] = {MAP(ROUTE23),                             SPAWN_ROUTE_23},
};
...
static u8 GetMapsecType(u8 mapsec)
{
	...
	case MAPSEC_ROUTE_23_VICTORY_ROAD:
		return FlagGet(FLAG_WORLD_MAP_VICTORY_ROAD_1F) ? MAPSECTYPE_VISITED : MAPSECTYPE_ROUTE;
    case MAPSEC_NONE:
        return MAPSECTYPE_NONE;
    default:
...
static void CreateDungeonIconSprite(u8 whichMap, u8 numIcons, u16 x, u16 y, u8 tileTag, u8 palTag)
{
    ...
    if ((GetMapsecType(mapsec) == MAPSECTYPE_VISITED || GetMapsecType(mapsec) == MAPSECTYPE_NOT_VISITED) && mapsec != MAPSEC_ROUTE_10_POKECENTER && mapsec != MAPSEC_ROUTE_23_VICTORY_ROAD)
        offset = 2;
