...
const u8 *const gMonIconTable[] = {
    ...
    [SPECIES_AKAGEROU] = gMonIcon_kagerou_helper,
    ...
    [SPECIES_CSUKUNA] = gMonIcon_sukuna_chibi,
    [SPECIES_SUKUNA] = gMonIcon_sukuna_neutral,
    [SPECIES_ASUKUNA] = gMonIcon_sukuna_attack,
    ...
    [SPECIES_LAYLA] = gMonIcon_layla_defense,
    [SPECIES_DLAYLA] = gMonIcon_layla_neutral,
