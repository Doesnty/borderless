...
const u8 gStartMenuText_Pokemon[] = _("Party");
...
const u8 gText_Boy[] = _("Unified Physics");
const u8 gText_Girl[] = _("Relative Psychology");
const u8 gText_PokedexTableOfContents[] = _("TOHODEX   TABLE OF CONTENTS");
...
const u8 gText_DexCategory_GrasslandPkmn[] = _("TH06 EOSD");
const u8 gText_DexCategory_ForestPkmn[] = _("TH07 PCB");
const u8 gText_DexCategory_WatersEdgePkmn[] = _("TH08 IN");
const u8 gText_DexCategory_SeaPkmn[] = _("TH09 POFV");
const u8 gText_DexCategory_CavePkmn[] = _("TH10 MOF");
const u8 gText_DexCategory_MountainPkmn[] = _("TH11 SA");
const u8 gText_DexCategory_RoughTerrainPkmn[] = _("TH12 UFO");
const u8 gText_DexCategory_UrbanPkmn[] = _("TH13 TD");
const u8 gText_DexCategory_RarePkmn[] = _("TH14 DDC");
const u8 gText_DexCategory_LOLKPkmn[] = _("TH15 LOLK");
const u8 gText_DexCategory_HSIFSPkmn[] = _("TH16 HSIFS");
const u8 gText_DexCategory_WBAWCPkmn[] = _("TH17 WBAWC");
const u8 gText_DexCategory_UMPkmn[] = _("TH18 UM");
const u8 gText_DexCategory_UDOALGPkmn[] = _("TH19 UDOALG");
const u8 gText_DexCategory_FWPkmn[] = _("TH20 FW");
const u8 gText_DexCategory_FightersPkmn[] = _("Fighting Games");
const u8 gText_DexCategory_WrittenWorksPkmn[] = _("Written Works");
const u8 gText_DexCategory_HRTPPkmn[] = _("TH01 HRTP");
const u8 gText_DexCategory_SOEWPkmn[] = _("TH02 SOEW");
const u8 gText_DexCategory_PODDPkmn[] = _("TH03 PODD");
const u8 gText_DexCategory_LLSPkmn[] = _("TH04 LLS");
const u8 gText_DexCategory_MSPkmn[] = _("TH05 MS");
const u8 gText_DexCategory_FanonPkmn[] = _("Fanon");
const u8 gText_DexCategory_SpecialPkmn[] = _("Special Puppets");
...
const u8 gText_ClosePokedex[] = _("CLOSE TOHODEX");
...
const u8 gText_WT[] = _("Cost:");
const u8 gText_PokedexQuotationMark[] = _("”"); // Unused
const u8 gText_Lbs[] = _("aum");
...
const u8 gText_DexStatsHP[] = _("HP");
const u8 gText_DexStatsAtk[] = _("Atk");
const u8 gText_DexStatsDef[] = _("Def");
const u8 gText_DexStatsSpA[] = _("SpA");
const u8 gText_DexStatsSpD[] = _("SpD");
const u8 gText_DexStatsSpe[] = _("Spe");
const u8 gText_DexStatsH[] = _("H: ");
...
const u8 gStartMenuText_Pokedex[] = _("Tohodex");
...
const u8 gText_PokeBalls2[] = _("Toho Orbs");
...
const u8 gText_OakForbidsUseOfItemHere[] = _("Oak's words echoed...\nThis isn't the time to use that!{PAUSE_UNTIL_PRESS}");
...
const u8 gUnknown_841665C[] = _("Played the Merlin Flute.\pNow, that's a catchy tune!{PAUSE_UNTIL_PRESS}");
const u8 gUnknown_8416690[] = _("Played the Merlin Flute.");
const u8 gUnknown_84166A7[] = _("The Merlin Flute awakened sleeping\nPuppets.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_ThatsSoldOut[] = _("That's sold out.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_OhNoICantBuyTMs[] = _("TMs? Oh, no.\nI can't take those from you.{PAUSE_UNTIL_PRESS}");
const u8 gText_OhNoICantBuyBerries[] = _("Berries? Oh, no.\nI can't buy those.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_SwitchAbility[] = _("Replace the Ability {STR_VAR_1}\nwith {STR_VAR_2}?");
const u8 gText_AbilityBecame[] = _("{STR_VAR_1}'s Ability\nbecame {STR_VAR_2}!{PAUSE_UNTIL_PRESS}");
...
const u8 gUnknown_8416B16[] = _("No more than three Puppets\nmay enter.{PAUSE_UNTIL_PRESS}");
const u8 gUnknown_8416B3E[] = _("No more than two Puppets\nmay enter.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_BagFullCouldNotRemoveItem[] = _("The {STR_VAR_1} is full. The Puppet's\nitem could not be removed.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_EffortWasReset[] = _("{STR_VAR_1}'s Effort was reset.{PAUSE_UNTIL_PRESS}");
...
ALIGNED(4) const u8 gText_OtherTrainersPkmnCantBeTraded[] = _("The other Trainer's Puppets\ncan't be traded now.");
...
const u8 gText_DoWhatWithPokemon[] = _("Do what?");
...
const u8 gText_ThreePkmnAreNeeded[] = _("Three Puppets are needed.");
...
const u8 gText_TwoPokemonAreNeeded[] = _("Two Puppets are needed.");
...
const u8 gText_LureWildPokemon[] = _("Lure wild Puppets.");
...
const u8 gText_Tm13_4000Coins[] = _("TM51{CLEAR_TO 0x48}{SMALL}2,000 COINS");
const u8 gText_Tm23_3500Coins[] = _("TM52{CLEAR_TO 0x48}{SMALL}2,000 COINS");
const u8 gText_Tm24_4000Coins[] = _("TM53{CLEAR_TO 0x48}{SMALL}2,000 COINS");
const u8 gText_Tm30_4500Coins[] = _("TM23{CLEAR_TO 0x48}{SMALL}3,500 COINS");
const u8 gText_Tm35_4000Coins[] = _("TM65{CLEAR_TO 0x48}{SMALL}7,000 COINS");
...
const u8 gText_Soulbadge[] = _("MarshBadge");
const u8 gText_Marshbadge[] = _("SoulBadge");
...
const u8 gText_Eevee[] = _("CReisen");
const u8 gText_Flareon[] = _("Reisen");
const u8 gText_Jolteon[] = _("DReisen");
const u8 gText_Vaporeon[] = _("TReisen");
const u8 gText_QuitLooking[] = _("No more Reisen");
...
const u8 gText_Abra_180Coins[] = _("CMiyoi{CLEAR_TO 0x55}{SMALL} 500 COINS");
const u8 gText_Clefairy_500Coins[] = _("CYuiman{CLEAR_TO 0x55}{SMALL} 511 COINS");
const u8 gText_Dratini_2800Coins[] = _("CSannyo{CLEAR_TO 0x4B}{SMALL} 1,000 COINS");
const u8 gText_Scyther_5500Coins[] = _("CMamizou{CLEAR_TO 0x4B}{SMALL} 3,500 COINS");
const u8 gText_Porygon_9999Coins[] = _("CJoon{CLEAR_TO 0x4B}{SMALL} 9,900 COINS");
const u8 gText_Abra_120Coins[] = _("CMike{CLEAR_TO 0x55}{SMALL}  80 COINS");
...
const u8 gText_Surf[] = _("Surf");
const u8 gText_ManaBurst[] = _("Mana Burst");
const u8 gText_BodySlam[] = _("Body Slam");
const u8 gText_FirePunch[] = _("Fire Punch");
const u8 gText_Hecatia[] = _("Hecatia");
const u8 gText_DPatchouli[] = _("DPatchouli");
const u8 gText_Kogasa[] = _("Kogasa");
const u8 gText_TKomachi[] = _("TKomachi");
...
const u8 gText_PokeBallsPocket[] = _("Toho Orbs Pocket");
const u8 gText_TmCase[] = _("TM Case");
...
const u8 gText_MiracleSeed_1000Coins[] = _("White Herb{CLEAR_TO 0x50}{SMALL}1,000 COINS");
const u8 gText_Charcoal_1000Coins[] = _("Scope Lens{CLEAR_TO 0x50}{SMALL}1,000 COINS");
const u8 gText_MysticWater_1000Coins[] = _("Wide Lens{CLEAR_TO 0x50}{SMALL}1,000 COINS");
...
const u8 gText_WithdrawMonDescription[] = _("You can withdraw a Puppet if you\nhave any in a Box.");
const u8 gText_DepositMonDescription[] = _("You can deposit your party\nPuppets in any Box.");
const u8 gText_MoveMonDescription[] = _("You can move Puppets that are\nstored in any Box.");
const u8 gText_MoveItemsDescription[] = _("You can move items held by any\nPuppets in a Box or your party.");
const u8 gText_SeeYaDescription[] = _("See you later!");
const u8 gText_JustOnePkmn[] = _("Can't deposit the last Puppet!");
const u8 gText_PartyFull[] = _("Can't take any more Puppets.");
...
const u8 gUnknown_84189EE[] = _("Stop giving the Puppet Mail?");
...
const u8 gText_PokemonCenter[] = _("Toho Center");
...
const u8 gText_PokeSum_MetInATrade_NatureChanged[] = _("{DYNAMIC 0x03} training, {DYNAMIC 0x00} nature.\nMet in a trade.");
const u8 gText_PokeSum_FatefulEncounterMet[] = _("{DYNAMIC 0x00} nature.\nMet in a fateful encounter when\nat {LV_2} {DYNAMIC 0x01}.");
const u8 gText_PokeSum_FatefulEncounterMet_NatureChanged[] = _("{DYNAMIC 0x03} training, {DYNAMIC 0x00} nature.\nMet in a fateful encounter when\nat {LV_2} {DYNAMIC 0x01}.");
const u8 gText_PokeSum_Met[] = _("{DYNAMIC 0x00} nature.\nMet in {DYNAMIC 0x02} at {LV_2} {DYNAMIC 0x01}.");
const u8 gText_PokeSum_Met_NatureChanged[] = _("{DYNAMIC 0x03} training, {DYNAMIC 0x00} nature.\nMet in {DYNAMIC 0x02} at {LV_2} {DYNAMIC 0x01}.");
const u8 gText_PokeSum_ApparentlyMet[] = _("{DYNAMIC 0x00} nature.\nApparently met in {DYNAMIC 0x02}\nat {LV_2} {DYNAMIC 0x01}.");
const u8 gText_PokeSum_ApparentlyMet_NatureChanged[] = _("{DYNAMIC 0x03} training, {DYNAMIC 0x00} nature.\nApparently met in {DYNAMIC 0x02}\nat {LV_2} {DYNAMIC 0x01}.");
const u8 gText_PokeSum_Hatched[] = _("{DYNAMIC 0x00} nature.\nHatched: {DYNAMIC 0x02}\nat {LV_2} {DYNAMIC 0x01}.");
const u8 gText_PokeSum_Hatched_NatureChanged[] = _("{DYNAMIC 0x03} training, {DYNAMIC 0x00} nature.\nHatched: {DYNAMIC 0x02}\nat {LV_2} {DYNAMIC 0x01}.");
...
const u8 gText_PokeSum_FatefulEncounterHatched_NatureChanged[] = _("{DYNAMIC 0x03} training, {DYNAMIC 0x00} nature. Met in a fateful\nencounter (hatched: {DYNAMIC 0x02}\nat {LV_2} {DYNAMIC 0x01}).");
...
const u8 gText_PokeSum_ApparentlyFatefulEncounterHatched_NatureChanged[] = _("{DYNAMIC 0x03} training, {DYNAMIC 0x00} nature. Apparently met in\na fateful encounter (hatched:\n{DYNAMIC 0x02} at {LV_2} {DYNAMIC 0x01}).");
const u8 gText_PokeSum_EggOrigin_DayCare[] = _("An odd Puppet Egg found by the\nDAY-CARE couple.");
const u8 gText_PokeSum_EggOrigin_TravelingMan[] = _("An odd Puppet Egg obtained from\nthe traveling man.");
const u8 gText_PokeSum_EggOrigin_NicePlace[] = _("A wondrously peculiar Puppet Egg\nobtained at a nice place.");
const u8 gText_PokeSum_EggOrigin_Spa[] = _("An odd Puppet Egg obtained from\nan old woman at the Spa.");
const u8 gText_PokeSum_EggOrigin_Trade[] = _("A peculiar Puppet Egg obtained\nin a trade.");
...
const u8 gText_PokeSum_PageName_PokemonInfo[] = _("PUPPET INFO");
const u8 gText_PokeSum_PageName_PokemonSkills[] = _("PUPPET SKILLS");
...
const u8 gText_BerryCrushes[] = _("CHEATS USED");
...
const u8 gText_MusicTouhou[] = _("Touhou");
const u8 gText_MusicPokemon[] = _("Pokémon");
...
const u8 gStartMenuDesc_Pokedex[] = _("A device that records Puppet secrets\nupon meeting or catching them.");
const u8 gStartMenuDesc_Pokemon[] = _("Check and organize Puppet that are\ntraveling with you in your party.");
...
const u8 gText_Pokedex[] = _("TOHODEX");
...
const u8 gTradeText_ChooseAPokemon[] = _("Choose a Puppet.");
...
const u8 gUnknown_841E16B[] = _("{COLOR DARK_GRAY}{HIGHLIGHT WHITE}{SHADOW LIGHT_GRAY}That's your only Puppet\nfor battle.");
...
const u8 gText_CantTutorMove[] = _("Another Puppet in the party must\nknow this move to teach it.");
...
const u8 gText_ZunNextPage[] = _("NEXT PAGE");
const u8 gText_ZunPreviousPage[] = _("PREVIOUS PAGE");
const u8 gText_ZunReimu[] = _("Reimu Hakurei");
const u8 gText_ZunMarisa[] = _("Marisa Kirisame");
const u8 gText_ZunRumia[] = _("Rumia");
const u8 gText_ZunDaiyousei[] = _("Daiyousei");
const u8 gText_ZunCirno[] = _("Cirno");
const u8 gText_ZunMeiling[] = _("Hong Meiling");
const u8 gText_ZunKoakuma[] = _("Koakuma");
const u8 gText_ZunPatchouli[] = _("Patchouli Knowledge");
const u8 gText_ZunSakuya[] = _("Sakuya Izayoi");
const u8 gText_ZunRemilia[] = _("Remilia Scarlet");
const u8 gText_ZunFlandre[] = _("Flandre Scarlet");
const u8 gText_ZunLetty[] = _("Letty Whiterock");
const u8 gText_ZunChen[] = _("Chen");
const u8 gText_ZunAlice[] = _("Alice Margatroid");
const u8 gText_ZunLilyWhite[] = _("Lily White");
const u8 gText_ZunLilyBlack[] = _("Lily Black");
const u8 gText_ZunLunasa[] = _("Lunasa Prismriver");
const u8 gText_ZunMerlin[] = _("Merlin Prismriver");
const u8 gText_ZunLyrica[] = _("Lyrica Prismriver");
const u8 gText_ZunYoumu[] = _("Youmu Konpaku");
const u8 gText_ZunYuyuko[] = _("Yuyuko Saigyouji");
const u8 gText_ZunRan[] = _("Ran Yakumo");
const u8 gText_ZunYukari[] = _("Yukari Yakumo");
const u8 gText_ZunSuika[] = _("Suika Ibuki");
const u8 gText_ZunWriggle[] = _("Wriggle Nightbug");
const u8 gText_ZunMystia[] = _("Mystia Lorelei");
const u8 gText_ZunKeine[] = _("Keine Kamishirasawa");
const u8 gText_ZunTewi[] = _("Tewi Inaba");
const u8 gText_ZunReisen[] = _("Reisen Udongein Inaba");
const u8 gText_ZunEirin[] = _("Eirin Yagokoro");
const u8 gText_ZunKaguya[] = _("Kaguya Houraisan");
const u8 gText_ZunMokou[] = _("Mokou Fujiwara");
const u8 gText_ZunAya[] = _("Aya Shameimaru");
const u8 gText_ZunMedicine[] = _("Medicine Melancholy");
const u8 gText_ZunYuuka[] = _("Yuuka Kazami");
const u8 gText_ZunKomachi[] = _("Komachi Onozuka");
const u8 gText_ZunEiki[] = _("Eiki Shiki");
const u8 gText_ZunAkyuu[] = _("Akyuu Hieda");
const u8 gText_ZunShizuha[] = _("Shizuha Aki");
const u8 gText_ZunMinoriko[] = _("Minoriko Aki");
const u8 gText_ZunHina[] = _("Hina Kagiyama");
const u8 gText_ZunNitori[] = _("Nitori Kawashiro");
const u8 gText_ZunMomiji[] = _("Momiji Inubashiri");
const u8 gText_ZunSanae[] = _("Sanae Kochiya");
const u8 gText_ZunKanako[] = _("Kanako Yasaka");
const u8 gText_ZunSuwako[] = _("Suwako Moriya");
const u8 gText_ZunReisenII[] = _("Reisen II");
const u8 gText_ZunToyohime[] = _("Toyohime Watatsuki");
const u8 gText_ZunYorihime[] = _("Yorihime Watatsuki");
const u8 gText_ZunIku[] = _("Iku Nagae");
const u8 gText_ZunTenshi[] = _("Tenshi Hinanawi");
const u8 gText_ZunKisume[] = _("Kisume");
const u8 gText_ZunYamame[] = _("Yamame Kurodani");
const u8 gText_ZunParsee[] = _("Parsee Mizuhashi");
const u8 gText_ZunYuugi[] = _("Yuugi Hoshiguma");
const u8 gText_ZunSatori[] = _("Satori Komeji");
const u8 gText_ZunRin[] = _("Rin Kaenbyou");
const u8 gText_ZunUtsuho[] = _("Utsuho Reiuji");
const u8 gText_ZunKoishi[] = _("Koishi Komeji");
const u8 gText_ZunNazrin[] = _("Nazrin");
const u8 gText_ZunKogasa[] = _("Kogasa Tatara");
const u8 gText_ZunIchirin[] = _("Ichirin Kumoi");
const u8 gText_ZunMurasa[] = _("Murasa Minamitsu");
const u8 gText_ZunShou[] = _("Shou Toramaru");
const u8 gText_ZunByakuren[] = _("Byakuren Hijiri");
const u8 gText_ZunNue[] = _("Nue Houjuu");
const u8 gText_ZunShanghai[] = _("Shanghai Doll");
const u8 gText_ZunHourai[] = _("Hourai Doll");
const u8 gText_ZunHatate[] = _("Hatate Himekaidou");
const u8 gText_ZunSunny[] = _("Sunny Milk");
const u8 gText_ZunLuna[] = _("Luna Child");
const u8 gText_ZunStar[] = _("Star Sapphire");
const u8 gText_ZunRinnosuke[] = _("Rinnosuke");
const u8 gText_ZunTokiko[] = _("Tokiko");
const u8 gText_ZunKyouko[] = _("Kyouko Kasodani");
const u8 gText_ZunYoshika[] = _("Yoshika Miyako");
const u8 gText_ZunSeiga[] = _("Seiga Kaku");
const u8 gText_ZunTojiko[] = _("Tojiko Soga");
const u8 gText_ZunFuto[] = _("Futo Mononobe");
const u8 gText_ZunMiko[] = _("Miko Toyosatomimi");
const u8 gText_ZunMamizou[] = _("Mamizou Futatsuiwa");
const u8 gText_ZunKosuzu[] = _("Kosuzu Motoori");
const u8 gText_ZunKokoro[] = _("Kokoro Hata");
const u8 gText_ZunWakasagihime[] = _("Wakasagihime");
const u8 gText_ZunSekibanki[] = _("Sekibanki");
const u8 gText_ZunKagerou[] = _("Kagerou Imaizumi");
const u8 gText_ZunBenben[] = _("Benben Tsukumo");
const u8 gText_ZunYatsuhashi[] = _("Yatsuhashi Tsukumo");
const u8 gText_ZunSeija[] = _("Seija Kijin");
const u8 gText_ZunShinmyoumaru[] = _("Shinmyoumaru Sukuna");
const u8 gText_ZunRaiko[] = _("Raiko Horikawa");
const u8 gText_ZunKasen[] = _("Kasen Ibara");
const u8 gText_ZunSumireko[] = _("Sumireko Usami");
const u8 gText_ZunSeiran[] = _("Seiran");
const u8 gText_ZunRingo[] = _("Ringo");
const u8 gText_ZunDoremy[] = _("Doremy Sweet");
const u8 gText_ZunSagume[] = _("Sagume Kishin");
const u8 gText_ZunClownpiece[] = _("Clownpiece");
const u8 gText_ZunJunko[] = _("Junko");
const u8 gText_ZunHecatia[] = _("Hecatia Lapislazuli");
const u8 gText_ZunJoon[] = _("Jo'on Yorigami");
const u8 gText_ZunShion[] = _("Shion Yorigami");
const u8 gText_ZunEternity[] = _("Eternity Larva");
const u8 gText_ZunNemuno[] = _("Nemuno Sakata");
const u8 gText_ZunAunn[] = _("Aunn Komano");
const u8 gText_ZunNarumi[] = _("Narumi Yatadera");
const u8 gText_ZunMai[] = _("Mai Teireida");
const u8 gText_ZunSatono[] = _("Satono Nishida");
const u8 gText_ZunOkina[] = _("Okina Matara");
const u8 gText_ZunEika[] = _("Eika Ebisu");
const u8 gText_ZunUrumi[] = _("Urumi Ushizaki");
const u8 gText_ZunKutaka[] = _("Kutaka Niwatari");
const u8 gText_ZunYachie[] = _("Yachie Kicchou");
const u8 gText_ZunMayumi[] = _("Mayumi Joutouguu");
const u8 gText_ZunKeiki[] = _("Keiki Haniyasushin");
const u8 gText_ZunSaki[] = _("Saki Kurokoma");
const u8 gText_ZunYuuma[] = _("Yuuma Toutetsu");
const u8 gText_ZunMike[] = _("Mike Goutokuji");
const u8 gText_ZunTakane[] = _("Takane Yamashiro");
const u8 gText_ZunSannyo[] = _("Sannyo Komakusa");
const u8 gText_ZunMisumaru[] = _("Misumaru Tamatsukuri");
const u8 gText_ZunTsukasa[] = _("Tsukasa Kudamaki");
const u8 gText_ZunMegumu[] = _("Megumu Iizunamaru");
const u8 gText_ZunChimata[] = _("Chimata Tenkyuu");
const u8 gText_ZunMomoyo[] = _("Momoyo Himemushi");
const u8 gText_ZunMiyoi[] = _("Miyoi Okunoda");
const u8 gText_ZunMizuchi[] = _("Mizuchi Miyadeguchi");
const u8 gText_ZunBiten[] = _("Son Biten");
const u8 gText_ZunEnoko[] = _("Enoko Mitsugashira");
const u8 gText_ZunChiyari[] = _("Chiyari Tenkajin");
const u8 gText_ZunHisami[] = _("Hisami Yomotsu");
const u8 gText_ZunZanmu[] = _("Zanmu Nippaku");
const u8 gText_ZunUbame[] = _("Ubame Chirizuka");
const u8 gText_ZunChimi[] = _("Chimi Houjuu");
const u8 gText_ZunNareko[] = _("Nareko Michigami");
const u8 gText_ZunYuiman[] = _("Yuiman Asama");
const u8 gText_ZunAriya[] = _("Ariya Iwanaga");
const u8 gText_ZunNina[] = _("Nina Watari");
const u8 gText_ZunHakurei[] = _("Reimu (PC-98)");
const u8 gText_ZunKirisame[] = _("Marisa (PC-98)");
const u8 gText_ZunShingyoku[] = _("Shingyoku");
const u8 gText_ZunMagan[] = _("YuugenMagan");
const u8 gText_ZunMima[] = _("Mima");
const u8 gText_ZunElis[] = _("Elis");
const u8 gText_ZunKikuri[] = _("Kikuri");
const u8 gText_ZunKonngara[] = _("Konngara");
const u8 gText_ZunSariel[] = _("Sariel");
const u8 gText_ZunGenji[] = _("Genji");
const u8 gText_ZunRika[] = _("Rika");
const u8 gText_ZunMeira[] = _("Meira");
const u8 gText_ZunEllen[] = _("Ellen");
const u8 gText_ZunKotohime[] = _("Kotohime");
const u8 gText_ZunKana[] = _("Kana Anaberal");
const u8 gText_ZunRikako[] = _("Rikako Asakura");
const u8 gText_ZunChiyuri[] = _("Chiyuri Kitashirakawa");
const u8 gText_ZunYumemi[] = _("Yumemi Okazaki");
const u8 gText_ZunRuukoto[] = _("Ruukoto");
const u8 gText_ZunOrange[] = _("Orange");
const u8 gText_ZunKurumi[] = _("Kurumi");
const u8 gText_ZunElly[] = _("Elly");
const u8 gText_ZunKazami[] = _("Yuuka (PC-98)");
const u8 gText_ZunMugetsu[] = _("Mugetsu");
const u8 gText_ZunGengetsu[] = _("Gengetsu");
const u8 gText_ZunSara[] = _("Sara");
const u8 gText_ZunLouise[] = _("Louise");
const u8 gText_ZunArisu[] = _("Alice (PC-98)");
const u8 gText_ZunYuki[] = _("Yuki");
const u8 gText_ZunMaiPC98[] = _("Mai (PC-98)");
const u8 gText_ZunYumeko[] = _("Yumeko");
const u8 gText_ZunShinki[] = _("Shinki");
const u8 gText_ZunSendai[] = _("Previous Hakurei");
const u8 gText_ZunTenma[] = _("Tenma");
const u8 gText_ZunLayla[] = _("Layla Prismriver");
const u8 gText_ZunYouki[] = _("Youki Konpaku");
const u8 gText_ZunTori[] = _("Birds");
